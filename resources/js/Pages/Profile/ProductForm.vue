        ...
        <div>
          ...
          <form @submit.prevent="submitForm" class="flex flex-col gap-y-4 my-4">
            ...
            <div>
              ...
              <TextInput id="price" name="price" v-model="form.price" type="number" class="mt-1 block w-full"
                required />
            </div>
            <div>
              <InputLabel for="stock" value="Stock" />
              <TextInput id="stock" name="stock" v-model="form.stock" type="number" class="mt-1 block w-full"
                required />
            </div>
            <div>
